# Tracked Threads — last updated 2026-06-29 07:00 Europe/Rome
...
- **29 Jun 07:00 re-check:** Fable 5 still suspended (Day 17). anthropic.com/news/fable-mythos-access re-fetched — still only the 12 Jun text, no dated addendum; newsroom newest still "Claude Tag," 23 Jun. Search ("Fable 5 access restored June 29") returns only the already-shipped 26 Jun Mythos re-release, the Axios "return soon" scoop (27 Jun, anticipatory/secondary), and aggregator headlines (Let's Data Science "Anthropic Restores Fable 5") that the primary anthropic.com pages contradict — the search summary itself states "as of June 29, 2026, Anthropic has not publicly announced any restoration." Legion docket still pre-ruling (no PI grant/deny, no government response since the 23 Jun filing). Watch-for unmet → no ADVANCE. (All three 28 Jun slots SKIPPED on the same status.)
