# Tracked Threads — last updated 2026-06-24 13:00 Europe/Rome
...
- **One-line state:** On 12 Jun the US government (Commerce Sec. Lutnick) issued a national-security export-control directive forcing Anthropic to suspend Claude Fable 5 and Mythos 5 for all foreign nationals — three days after Fable 5's 9 Jun public launch. Cited reason: a narrow "jailbreak" (getting the model to read a codebase and flag software flaws), with reported fear the models could reach Chinese/Russian military intelligence. A bipartisan House letter (18 Jun) demanded the directive's legal justification; Anthropic and the administration are reported to be negotiating. As of 24 Jun (13:00) both models remain offline (Day 12); Anthropic's newest newsroom post is still "Introducing Claude Tag" (23 Jun), a team-collaboration feature unrelated to the suspension. No restoration date, no formal written rescission; the "coming days" line is still the 17 Jun Seoul framing. Sits alongside Trump's 2 Jun executive order creating a voluntary 30-day federal pre-release review for frontier models. NOTE (unconfirmed, secondary-only): blogs claim NSA Director Gen. Joshua Rudd told the Senate Intel Committee that Mythos autonomously breached NSA classified systems in a red-team — no primary, not shippable; watch for an official transcript/statement.
- **Watch for:** restoration of Fable 5 / Mythos 5 access (a dated announcement), a formal/written government order or rescission, a court filing, a fresh Anthropic policy statement, or a primary source on the NSA red-team claim. Any of these = post (ADVANCE this thread).
- **Receipts:**
