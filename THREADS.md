# Tracked Threads — last updated 2026-07-10 07:00 Europe/Rome
...
- **Status:** developing (GPT-5.6 GA shipped 09 Jul; system card POSTED 10 Jul 07:00 — the shippable primary finally landed)
- **Last material update:** 2026-07-09 (GPT-5.6 Sol/Terra/Luna general availability + official system card published)
- **Last POSTED:** 2026-07-10 07:00 (GPT-5.6 system card — final Preparedness designations: High cyber + High bio/chem, below High on self-improvement; verbatim cyber-capability line)
- **One-line state:** A pattern where the US government conditions who can access frontier models on national-security grounds. First instance was T1 (12 Jun export-control directive forcing Anthropic to suspend Fable 5 / Mythos 5; both controls fully lifted 30 Jun, Fable 5 back 1 Jul, safeguards regime published 2 Jul — see T1). Second: on 26 Jun OpenAI began a *limited preview* of GPT-5.6 (Sol/Terra/Luna) restricted to ~20 government-shared partners (POSTED 26 Jun 20:00); the US Commerce Dept then cleared it for broad release, GA shipping mid-day 09 Jul across ChatGPT/Codex/API. **10 Jul 07:00: POSTED the GPT-5.6 system card** via `deploymentsafety.openai.com/gpt-5-6` — the one openable OpenAI primary, dated 09 Jul, carrying final Preparedness designations (Sol/Terra/Luna "High" in both Cybersecurity and Biological & Chemical; none reach the High threshold in AI Self-Improvement), a HealthBench Professional figure (Sol 60.5, +8.7), and a verbatim cyber-capability sentence. Anchored strictly to the card — no GA/pricing claim in the post. STILL unshippable separately: the GA/pricing story — `openai.com/index/gpt-5-6` (403), per-tier pricing (Sol $5/$30, Terra $2.50/$15, Luna $1/$6), Terminal-Bench 2.1 (Sol 88.8% / Sol Ultra 91.9%) — lives only on 403'd marketing pages + banned aggregators/personal blogs.
- **Watch for:** an OPENABLE allowlisted primary/Tier-2 carrying GPT-5.6 GA + per-tier pricing or a coding-benchmark figure (openai.com/index rendering to the fetcher, or a 09–10 Jul TechCrunch/Reuters GA piece) — that would be a distinct ADVANCE (the GA/pricing beat the system-card post deliberately left out). Also: a White-House/Commerce primary on the clearance; independent third-party GPT-5.6 benchmarks. Do NOT re-post the system-card designations (posted 10 Jul 07:00). Restatement via blocked/paywalled/aggregator outlets does not clear the gate.
- **Receipts:**
  - https://deploymentsafety.openai.com/gpt-5-6 (09 Jul — GPT-5.6 GA system card; OPENABLE to the fetcher; final Preparedness designations + benchmark figures — POSTED 10 Jul 07:00)
  - https://openai.com/index/gpt-5-6 (09 Jul — GPT-5.6 GA / pricing marketing page; still 403s to automated fetch)
  - https://openai.com/index/government-national-security-partnerships (08 Jul — OpenAI on the government partnership process; 403s; confirmed via openai.com RSS)
  - https://deploymentsafety.openai.com/gpt-5-6-preview (GPT-5.6 preview system card — limited preview, government-shared partners — POSTED 26 Jun 20:00)
...
- **Watch for:** a concrete step out of the Action Plan (ENISA platform launch, the Grand Challenge opening, a named funding/date figure, or the model-evaluation capacity going live); an openable allowlisted primary confirming GPT-5.5-Cyber + its benchmark numbers; a published GPT-5.6 cyber benchmark with a number; a finalized CJS framework or a Fable 5 classifier block-rate number. Don't re-post the bare Action Plan presentation (09 Jul). **09 Jul 20:00 recheck:** no concrete step out of the Action Plan; GPT-5.6 GA (T5) shipped but the system card / cyber-benchmark numbers remain behind 403s. **10 Jul 07:00 recheck:** the GPT-5.6 system card (posted under T5) is now openable and rates GPT-5.6 "High" in cybersecurity, with a verbatim finding that Sol/Terra "can find vulnerabilities and pieces of exploits" but could not carry out "autonomous, end-to-end attacks against hardened targets" — a cyber-capability data point tying T3, shipped under T5. No concrete step out of the EU Action Plan.
- **Receipts:**
