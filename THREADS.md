# Tracked Threads — last updated 2026-06-25 13:00 Europe/Rome
...
- **One-line state:** On 12 Jun the US government (Commerce Sec. Lutnick) issued a national-security export-control directive forcing Anthropic to suspend Claude Fable 5 and Mythos 5 for all foreign nationals — three days after Fable 5's 9 Jun public launch. Cited reason: a narrow "jailbreak" (getting the model to read a codebase and flag software flaws), with reported fear the models could reach Chinese/Russian military intelligence. A bipartisan House letter (18 Jun) demanded the directive's legal justification; Anthropic and the administration are reported to be negotiating. As of 25 Jun (13:00) both models remain offline (Day 13); Anthropic's newest newsroom post is still "Introducing Claude Tag" (23 Jun), unrelated to the suspension. No restoration date, no formal written rescission. NOTE (still unconfirmed by primary): reporting that Commerce talks have grown smoother with Anthropic co-founder/chief compute officer Tom Brown leading negotiations, Chris Ciauri's "very confident… in the coming days" line, and Polymarket "next week" odds reportedly jumping to ~60% — all secondary (X posts, Korea JoongAng Daily, explainx), no Anthropic/government primary. The earlier NSA red-team claim (Mythos breaching NSA systems) still traces only to Sen. Mark Warner relaying NSA Director Gen. Joshua Rudd's briefing; NSA/DoD/White House have not corroborated and no primary document exists. A "Beijing blacklisted 56 American firms" retaliation item surfaced via aggregators only — no allowlisted primary (China MOFCOM not on the gov allowlist). None shippable. (Separately: "Project Glasswing" is Anthropic's own vulnerability-disclosure partner program — not the NSA test codename; earlier blog conflation noted and discarded.)
