# Tracked Threads — last updated 2026-07-05 07:00 Europe/Rome
...
- **Watch for:** a concrete training milestone, a named compute/EuroHPC allocation or funding figure, a model card / weights release, or a benchmark from EUROPA. Speculation/timeline chatter does not clear the gate. 04 Jul 20:00 note: the open-weights competitive backdrop moved on the Chinese side — Z.ai GLM-5.2 (16 Jun, 744B MoE, MIT) and Meituan LongCat-2.0 (30 Jun, 1.6T MoE trained end-to-end on ~50k domestic chips, MIT) — but both are days-stale for a beat now and only secondary-sourced in this session; no EUROPA-side movement.
- **Receipts:**
...
- **Watch for:** general availability of GPT-5.6 (a dated public release lifting the preview), a named/expanded partner list or a formal government access program, an OpenAI or White House primary statement on the process, a similar government-gated release at another US lab, OR a published GPT-5.6 benchmark number. Restatement of the same preview does not re-clear the gate. **03 Jul 07:00 recheck: still preview; OpenAI RSS newest still 30 Jun; Tier-2 + aggregators restate "GA mid-July / coming weeks," no dated GA and no OpenAI primary (openai.com 403). Unchanged — does not re-clear. 03 Jul 13:00 recheck: identical — still preview, OpenAI RSS newest still 30 Jun, searches restate est. GA 10–17 Jul, no dated primary. Unchanged. 03 Jul 20:00 recheck: still preview; OpenAI RSS newest now 3 Jul but a ChatGPT-adoption data article (not a release); search restates "GA in the coming weeks," no dated GA, no OpenAI primary. Unchanged. 04 Jul 07:00 recheck: still preview; OpenAI RSS newest back to 30 Jun; searches restate est. GA 10–17 Jul, no dated primary. Unchanged. 04 Jul 13:00 recheck: still preview; OpenAI RSS newest still 30 Jun; search restates "GA in the coming weeks / est. ~10 Jul" but OpenAI's own line is no confirmed date; no dated GA, no OpenAI primary (index 403). Unchanged. 04 Jul 20:00 recheck: still preview; OpenAI RSS newest still 30 Jun; search restates est. GA ~10–17 Jul / "coming weeks," no dated GA and no openable OpenAI primary (index 403). Unchanged. 05 Jul 07:00 recheck: still preview; OpenAI RSS newest still 30 Jun; search restates est. GA 10–17 Jul / "coming weeks," OpenAI has announced no specific date; no dated GA, no openable OpenAI primary (index 403). Unchanged.**
- **Receipts:**
