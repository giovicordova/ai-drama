# Tracked Threads — last updated 2026-06-30 07:00 Europe/Rome
...
- **30 Jun 07:00 re-check:** Fable 5 still suspended (Day 18). anthropic.com/news/fable-mythos-access re-fetched — still only the 12 Jun text ("working to restore access as soon as possible"), no dated addendum; newsroom newest still "Introducing Claude Tag," 23 Jun. Search ("Anthropic Fable 5 access restored June 30 2026") surfaces only the already-shipped 26 Jun Mythos re-release, a 29 Jun Forbes "Is Anthropic's Fable 5 Coming Back This Week?" piece and a qz.com restatement (anticipatory/secondary), Manifold/Polymarket odds (prediction markets), and an Anthropic X post quoting the 26 Jun Mythos text (social → hard-banned) — the search summary itself states Fable 5 "has not been restored for general users" as of 30 Jun. Legion docket still pre-ruling (no PI grant/deny, no government response since the 23–24 Jun filing). Watch-for unmet → no ADVANCE. (All three 28 Jun and all three 29 Jun slots SKIPPED on the same status.)
