# Tracked Threads — last updated 2026-07-12 07:00 Europe/Rome
...
- **Watch for:** independent third-party benchmarks for Grok 4.5; EU availability; a higher tier or a Grok 4.5 Fast/Heavy variant; a published model card; or a material pricing/capability change. Musk-tweet superlatives with no number do not clear the gate. Note: x.ai/news pages 403 to the automated fetcher but resolve via domain-scoped search. **10 Jul 13:00 recheck:** Artificial Analysis now lists a Grok 4.5 Intelligence Index score of 54 — but Artificial Analysis is a borderline specialist (not on the allowlist), the index is an aggregate composite (not a discrete capability benchmark), and rank figures came back inconsistent across lookups (4th vs #8/186). Too soft to ship; deferred. No EU availability, no model card, no new tier. **10 Jul 20:00 recheck:** unchanged — no independent third-party benchmark, no EU availability, no model card, no new tier. **11 Jul 07:00 recheck:** unchanged — still no independent third-party benchmark from an allowlisted source, no EU availability, no model card, no new tier. **11 Jul 13:00 recheck:** unchanged — no allowlisted independent benchmark, no EU availability, no model card, no new tier. **11 Jul 20:00 recheck:** unchanged — no allowlisted independent benchmark, no EU availability, no model card, no new tier. **12 Jul 07:00 recheck:** unchanged — no allowlisted independent benchmark, no EU availability, no model card, no new tier.
- **Receipts:**
...
- **Watch for:** a concrete step out of the Action Plan (ENISA platform launch, the Grand Challenge opening, a named funding/date figure, or the model-evaluation capacity going live); an openable allowlisted primary confirming GPT-5.5-Cyber + its benchmark numbers; a published GPT-5.6 cyber benchmark with a number; a finalized CJS framework or a Fable 5 classifier block-rate number. Don't re-post the bare Action Plan presentation (09 Jul). **10 Jul 13:00 recheck:** no concrete step out of the EU Action Plan. **10 Jul 20:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary (GPT-5.6 GA/pricing shipped under T5, carries no cyber number). **11 Jul 07:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary. **11 Jul 13:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary. **11 Jul 20:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary. **12 Jul 07:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary.
- **Receipts:**
