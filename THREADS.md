# Tracked Threads — last updated 2026-07-10 13:00 Europe/Rome
...
- **Status:** developing (GPT-5.6 GA shipped 09 Jul; system card POSTED 10 Jul 07:00; GA/pricing now Tier-2-openable — a live ADVANCE not yet shipped)
...
- **One-line state:** A pattern where the US government conditions who can access frontier models on national-security grounds. First instance was T1 (12 Jun export-control directive forcing Anthropic to suspend Fable 5 / Mythos 5; both controls fully lifted 30 Jun, Fable 5 back 1 Jul, safeguards regime published 2 Jul — see T1). Second: on 26 Jun OpenAI began a *limited preview* of GPT-5.6 (Sol/Terra/Luna) restricted to ~20 government-shared partners (POSTED 26 Jun 20:00); the US Commerce Dept then cleared it for broad release, GA shipping mid-day 09 Jul across ChatGPT/Codex/API. **10 Jul 07:00: POSTED the GPT-5.6 system card** via `deploymentsafety.openai.com/gpt-5-6` — Sol/Terra/Luna "High" in both Cybersecurity and Biological & Chemical, none reaching High in AI Self-Improvement; HealthBench Professional (Sol 60.5, +8.7); verbatim cyber-capability sentence. **10 Jul 13:00: the GA/pricing beat is NOW OPENABLE** via a Tier-2 primary — TechCrunch (09 Jul) carries GA (ChatGPT/Codex/API) + per-tier pricing (Sol $5/$30, Terra $2.50/$15, Luna $1/$6) — the distinct ADVANCE the watch named; deferred this slot to Meta (T8, net-new release), still shippable later. Headline "Artificial Analysis Coding Agent Index 80, new state of the art, 2.8 pts above Fable 5" is a best-at-X claim → Tier-2 can't be sole source; primary `openai.com/index/gpt-5-6` still 403s.
- **Watch for:** ship the GA/pricing ADVANCE at a later slot (GA + per-tier pricing as plain facts via TechCrunch/Reuters; capability/"state of the art" claim needs an openable primary or independent benchmark). Also: a White-House/Commerce primary on the clearance; independent third-party GPT-5.6 benchmarks; the `openai.com/index` page rendering. Do NOT re-post the system-card designations (07:00). Restatement via blocked/paywalled/aggregator outlets does not clear the gate.
- **Receipts:**
  ...
  - https://techcrunch.com/2026/07/09/openai-launches-its-new-family-of-models-with-gpt-5-6/ (09 Jul — Tier-2, GA + per-tier pricing + Coding Agent Index; OPENABLE — the GA/pricing ADVANCE, not yet shipped)
...
- **Watch for:** a higher-tier Claude 5 release (e.g. an Opus-line model), a published SWE-bench Verified or other coding number for Sonnet 5 or Fable 5, an independent third-party benchmark, or a material capability/pricing change. A restatement of the 30 Jun launches does not re-clear. 10 Jul 07:00/13:00 rechecks: Anthropic newsroom's newest items are governance/comms/product (see T1) — no Opus-line release, no new Claude 5 benchmark. Unchanged.
- **Receipts:**
