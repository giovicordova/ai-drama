# Tracked Threads — last updated 2026-06-24 20:00 Europe/Rome
...
- **One-line state:** On 12 Jun the US government (Commerce Sec. Lutnick) issued a national-security export-control directive forcing Anthropic to suspend Claude Fable 5 and Mythos 5 for all foreign nationals — three days after Fable 5's 9 Jun public launch. Cited reason: a narrow "jailbreak" (getting the model to read a codebase and flag software flaws), with reported fear the models could reach Chinese/Russian military intelligence. A bipartisan House letter (18 Jun) demanded the directive's legal justification; Anthropic and the administration are reported to be negotiating. As of 24 Jun (20:00) both models remain offline (Day 12); Anthropic's newest newsroom post is still "Introducing Claude Tag" (23 Jun), a team-collaboration feature unrelated to the suspension. No restoration date, no formal written rescission. NOTE (still unconfirmed by primary): the NSA red-team claim — that Mythos breached "almost all" NSA classified systems in hours during an authorized test — now traces to Sen. Mark Warner relaying NSA Director Gen. Joshua Rudd's briefing (carried by Tom's Hardware and others), but NSA/DoD/White House have declined to corroborate and no primary government document has been released. Not shippable. (Separately: "Project Glasswing" is Anthropic's own vulnerability-disclosure partner program — not the NSA test codename; earlier blog conflation noted and discarded.)
