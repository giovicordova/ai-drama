# Tracked Threads — last updated 2026-07-12 20:00 Europe/Rome
...
- **Watch for:** an independent/peer expert verdict on the proof's correctness (confirmation OR a found gap — either is a beat); an OpenAI blog/index page (openable) framing the achievement; a further AI-generated proof of another named open problem; or Sol Ultra confirmed as a publicly available tier. Do NOT re-post the bare 12 Jul proof drop. A restated "AI solves 50-yr problem" via aggregators with no new primary does not clear the gate.
- **Receipts:**
