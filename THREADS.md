# Tracked Threads — last updated 2026-07-12 13:00 Europe/Rome
...
- **Watch for:** a named benchmark figure from the Muse Spark 1.1 Evaluation Report or an independent third-party benchmark (SWE-bench Verified / Terminal-Bench / coding-agent index with a number); open-weights availability; a higher tier or a Muse Spark 2 release; or a material pricing/availability change (e.g. Model API leaving preview / EU availability). Don't re-post the bare 09 Jul release. Vague "major gains" with no number does not clear the gate. **10 Jul 20:00 recheck:** unchanged since 13:00 — no benchmark extracted from the Evaluation Report PDF, no new tier/pricing on the Meta primary, Model API still public preview. **11 Jul 07:00 recheck:** unchanged — no benchmark extractable from the Evaluation Report PDF, no new tier/pricing on the Meta primary, Model API still public preview. **11 Jul 13:00 recheck:** unchanged — HF newest is community Qwen/Gemma finetunes, no Meta primary movement; no benchmark, tier, or pricing change. **11 Jul 20:00 recheck:** unchanged — HF newest still community Qwen/RWKV variants, no Meta primary movement; no benchmark, tier, or pricing change; Model API still public preview. **12 Jul 07:00 recheck:** unchanged — HF newest is community Qwen3-Coder GGUF quants, no Meta primary movement; no benchmark, tier, or pricing change; Model API still public preview. **12 Jul 13:00 recheck:** unchanged — HF newest still community Qwen/Gemma finetunes, no Meta primary movement; no benchmark, tier, or pricing change; Model API still public preview.
- **Receipts:**
...
- **Last material update:** 2026-07-09 (GPT-5.6 Sol/Terra/Luna general availability + official system card published)
...
- **One-line state:** A pattern where the US government conditions who can access frontier models on national-security grounds. First instance was T1 (12 Jun export-control directive forcing Anthropic to suspend Fable 5 / Mythos 5; both controls fully lifted 30 Jun, Fable 5 back 1 Jul, safeguards regime published 2 Jul — see T1). Second: on 26 Jun OpenAI began a *limited preview* of GPT-5.6 (Sol/Terra/Luna) restricted to ~20 government-shared partners (POSTED 26 Jun 20:00); the US Commerce Dept then cleared it for broad release, GA shipping mid-day 09 Jul across ChatGPT/Codex/API. **10 Jul 07:00: POSTED the GPT-5.6 system card** via `deploymentsafety.openai.com/gpt-5-6` — Sol/Terra/Luna "High" in both Cybersecurity and Biological & Chemical, none reaching High in AI Self-Improvement; HealthBench Professional (Sol 60.5, +8.7); verbatim cyber-capability sentence. **10 Jul 20:00: POSTED the GA + per-tier pricing ADVANCE** — GA across ChatGPT/Codex/API + per-tier API pricing (Sol $5/$30, Terra $2.50/$15, Luna $1/$6) as plain facts, anchored to the openable Tier-2 primary (TechCrunch, 09 Jul). The best-at-X headline ("Artificial Analysis Coding Agent Index 80, new state of the art, 2.8 pts above Fable 5") was **deliberately excluded** — Tier-2 can't be the sole source for a best-at-X claim, and the `openai.com/index/gpt-5-6` primary still 403s. Both distinct GPT-5.6 beats (system card; GA+pricing) are now shipped.
- **Watch for:** an openable allowlisted primary or independent third-party benchmark for the "state of the art"/Coding Agent Index claim (that would let the capability/best-at-X beat ship); a White-House/Commerce primary on the clearance; the `openai.com/index` page rendering to the fetcher; a new GPT-5.6 tier (e.g. Sol Ultra) or a material pricing change. Do NOT re-post the system-card designations (07:00) or the bare GA/pricing (20:00). Restatement via blocked/paywalled/aggregator outlets does not clear the gate. **11 Jul 07:00 recheck:** `openai.com/index/gpt-5-6` still 403s → best-at-X (Coding Agent Index) still unshippable; White House frontier-AI framework primaries (NSPM-11 / EO 14409 / "Promoting Advanced AI Innovation and Security") are June 2026, not new since last run; no fresh 10–11 Jul White-House/Commerce clearance primary. Both GPT-5.6 beats stay shipped. **11 Jul 13:00 recheck:** `openai.com/index/gpt-5-6` still 403s → best-at-X still blocked; OpenAI news newest still the 10 Jul Deutsche Telekom story atop the 09 Jul items; no fresh clearance primary. Both beats stay shipped. **11 Jul 20:00 recheck (US-lab launch window):** `openai.com/index/gpt-5-6` still 403s → best-at-X still blocked; OpenAI news newest still the 10 Jul Deutsche Telekom story; White House voluntary frontier-AI framework still June-2026 primaries + "expected soon" reporting, no fresh 10–11 Jul clearance primary. Both beats stay shipped. **12 Jul 07:00 recheck:** `openai.com/index/gpt-5-6` still 403s → best-at-X still blocked; OpenAI news newest still the 10 Jul Deutsche Telekom story; no fresh 10–12 Jul White-House/Commerce clearance primary. Both beats stay shipped. **12 Jul 13:00 recheck:** `openai.com/index/gpt-5-6` still 403s → best-at-X still blocked; an aggregator-floated "Sol Ultra" tier + Cycle-Double-Cover-Conjecture proof story has no OpenAI primary rendered, so no new tier beat; OpenAI news newest still the 10 Jul Deutsche Telekom story; no fresh clearance primary. Both beats stay shipped.
- **Receipts:**
...
- **Watch for:** independent third-party benchmarks for Grok 4.5; EU availability; a higher tier or a Grok 4.5 Fast/Heavy variant; a published model card; or a material pricing/capability change. Musk-tweet superlatives with no number do not clear the gate. Note: x.ai/news pages 403 to the automated fetcher but resolve via domain-scoped search. **10 Jul 13:00 recheck:** Artificial Analysis now lists a Grok 4.5 Intelligence Index score of 54 — but Artificial Analysis is a borderline specialist (not on the allowlist), the index is an aggregate composite (not a discrete capability benchmark), and rank figures came back inconsistent across lookups (4th vs #8/186). Too soft to ship; deferred. No EU availability, no model card, no new tier. **10 Jul 20:00 recheck:** unchanged — no independent third-party benchmark, no EU availability, no model card, no new tier. **11 Jul 07:00 recheck:** unchanged — still no independent third-party benchmark from an allowlisted source, no EU availability, no model card, no new tier. **11 Jul 13:00 recheck:** unchanged — no allowlisted independent benchmark, no EU availability, no model card, no new tier. **11 Jul 20:00 recheck:** unchanged — no allowlisted independent benchmark, no EU availability, no model card, no new tier. **12 Jul 07:00 recheck:** unchanged — no allowlisted independent benchmark, no EU availability, no model card, no new tier. **12 Jul 13:00 recheck:** unchanged — no allowlisted independent benchmark, no EU availability, no model card, no new tier.
- **Receipts:**
...
- **Watch for:** a ruling on the Legion LegalTech PI motion (grant/deny) or the government's filed response (14 Jul); a finalized/revised CJS framework or a named benchmark/block-rate number on the Fable 5 classifier; a PRIMARY government source (Commerce/BIS/White House); or a PRIMARY on the NSA red-team claim. Don't re-post the bare restoration (01 Jul) or the draft CJS framework (03 Jul). **10 Jul 13:00 recheck:** unchanged since 07:00 — Anthropic newsroom newest still the 09 Jul governance/comms/product items (Bernanke to LTBT; "Inviting hard questions"; Claude-reflection feature; UST case study); litigation schedule unchanged, no docket ruling. **10 Jul 20:00 recheck:** unchanged — newsroom newest still the 09 Jul items; no docket ruling; pre-14-Jul litigation schedule holds. **11 Jul 07:00 recheck:** unchanged — newsroom newest still the 09 Jul items; no docket ruling; government response due 14 Jul; schedule holds. **11 Jul 13:00 recheck:** unchanged — newsroom newest still the 09 Jul items (+ 06 Jul Alberta case study); no docket ruling; government response due 14 Jul; schedule holds. **11 Jul 20:00 recheck:** unchanged — newsroom newest still the 09 Jul items (+ 06 Jul Alberta); no docket ruling; government response due 14 Jul; schedule holds. **12 Jul 07:00 recheck:** unchanged — newsroom newest still the 09 Jul items; no docket ruling; government response due 14 Jul; schedule holds. **12 Jul 13:00 recheck:** unchanged — newsroom newest still the 09 Jul items; no docket ruling; government response due 14 Jul; schedule holds.
- **Receipts:**
...
- **Watch for:** a concrete step out of the Action Plan (ENISA platform launch, the Grand Challenge opening, a named funding/date figure, or the model-evaluation capacity going live); an openable allowlisted primary confirming GPT-5.5-Cyber + its benchmark numbers; a published GPT-5.6 cyber benchmark with a number; a finalized CJS framework or a Fable 5 classifier block-rate number. Don't re-post the bare Action Plan presentation (09 Jul). **10 Jul 13:00 recheck:** no concrete step out of the EU Action Plan. **10 Jul 20:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary (GPT-5.6 GA/pricing shipped under T5, carries no cyber number). **11 Jul 07:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary. **11 Jul 13:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary. **11 Jul 20:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary. **12 Jul 07:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary. **12 Jul 13:00 recheck:** no concrete step out of the Action Plan; no new openable allowlisted cyber-benchmark primary.
- **Receipts:**
...
- **Watch for:** a higher-tier Claude 5 release (e.g. an Opus-line model), a published SWE-bench Verified or other coding number for Sonnet 5 or Fable 5, an independent third-party benchmark, or a material capability/pricing change. A restatement of the 30 Jun launches does not re-clear. 10 Jul 07:00/13:00/20:00 + 11 Jul 07:00/13:00/20:00 + 12 Jul 07:00/13:00 rechecks: Anthropic newsroom's newest items are governance/comms/product (see T1) — no Opus-line release, no new Claude 5 benchmark. Google DeepMind blog shows no Gemini 3.5 Pro GA — reported-only for ~17 Jul. Unchanged.
- **Receipts:**
