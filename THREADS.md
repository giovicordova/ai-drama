# Tracked Threads — last updated 2026-06-28 07:00 Europe/Rome
...
- **28 Jun 07:00 re-check:** Fable 5 still suspended (Day 16). anthropic.com/news/fable-mythos-access still shows only the 12 Jun text (re-fetched); newsroom newest still "Claude Tag," 23 Jun — no dated restoration, no written Anthropic/Commerce primary. Only fresh hit: an Axios scoop (27 Jun) saying Fable 5 is "on track to return soon" with limits possibly "lifted as soon as the coming week" — anticipatory, secondary (Axios off-allowlist), pre-restoration; not a beat. Legion docket still pre-ruling (no PI grant/deny, no government response). Watch-for unmet → no ADVANCE.
